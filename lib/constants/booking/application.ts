...
export const BOOKING_APPLICATION_OCCUPANCY_TYPES: {
	...
	sequence?: number;
}[] = [
		{
			...
			description:
				"One adult living alone. You will be the sole occupant of the property.",
			sequence: 1,
		},
		{
			label: "Couple",
			...
			description:
				"Two adults living together, such as married spouses or partners.",
			sequence: 2,
		},
		{
			label: "Small Family",
			...
			description:
				"A household of 3 to 4 people, typically parents with one or two children.",
			sequence: 3,
		},
		{
			label: "Large Family",
...
export const BOOKING_APPLICATION_STATUS_COLORS: Record<
	BookingApplicationStatus,
	string
> = {
