        ...
        >
          ...
          <View className="flex-row items-center justify-between gap-3">
            <View className="flex-1 flex-row items-center gap-1.5">
              ...
              >
                {joinLocation(hosting.state, hosting.country)}
              </ThemedText>
            </View>
            {isMultiUnit ? (
              <ThemedText
...
export const HostingCardSkeleton = () => {
  return (
    <View className="gap-3.5">
      ...
      <View className="gap-2 rounded-3xl p-4" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }}>
  ...
  return (
    <View className="gap-8">
      ...
      <View className="gap-4">
        ...
        {/* Description Section */}
        <View className="mt-8 pb-8" style={{ borderBottomWidth: 0 }}>
          <Skeleton
            style={{
              height: 22,
              width: 120,
