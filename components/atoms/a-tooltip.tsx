...
const Tooltip: React.FC<TooltipProps> = ({
  ...
  if (placement === 'right' || placement === 'left') {
    const fitsRight = coords.x + coords.width + GAP + ttWidth <= SCREEN_WIDTH - MARGIN;
  ...
  if (placement === 'top' || placement === 'bottom') {
    ...
    const fitsBelow = coords.y + coords.height + GAP + ttHeight <= SCREEN_HEIGHT - MARGIN;
  ...
  if (placement === 'top' || placement === 'bottom') {
    ...
    windowTop = placement === 'top' ? coords.y - GAP - ttHeight : coords.y + coords.height + GAP;
  } else {
    windowLeft = placement === 'right' ? coords.x + coords.width + GAP : coords.x - GAP - ttWidth;
    windowTop = clamp(
          ...
          >
            <Animated.View
              onLayout={(e) => {
                ...
                if (w && h && (w !== tooltipSize.width || h !== tooltipSize.height)) {
            ...
            >
              ...
              <View style={[styles.arrow, { backgroundColor: colors.text }, arrowPosStyle]} />
            </Animated.View>
          </Pressable>
        </Portal>
      )}
