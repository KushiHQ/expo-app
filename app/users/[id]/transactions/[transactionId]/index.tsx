    ...
    <>
      ...
      >
        <ScrollView className="flex-1 px-6 pb-10 pt-4">
            ...
            >
              <View className="flex-row items-center justify-between">
                ...
                <View className="flex-row items-center gap-2" style={{ flexShrink: 1 }}>
                  ...
                  <CopyButton text={transaction.reference ?? ''} size={16} color={colors.primary} />
                </View>
              </View>
              ...
              <View className="flex-row justify-between gap-4">
                ...
                <ThemedText
                  style={{ fontSize: 14, flex: 1, textAlign: 'right', textTransform: 'capitalize' }}
                >
              ...
              {transaction.booking && (
                <Pressable
                  onPress={() => router.push(`/bookings/${transaction.booking?.id}`)}
          ...
          <View className="mt-6 flex-row items-center gap-4">
            ...
            >
              <View className="flex-row items-center justify-center gap-2">
                ...
                <ThemedText content="tinted" style={{ fontSize: 14, fontFamily: Fonts.semibold }}>
                  Share PDF
                </ThemedText>
              </View>
            </Button>
          ...
          {/* Help Section */}
          <View
            className="mb-10 mt-8 items-center rounded-2xl border p-6"
            style={{ borderColor: hexToRgba(colors.text, 0.05) }}
          >
      ...
      <ThemedModal visible={!!downloadType} onClose={() => setDownloadType(undefined)}>
        ...
        >
          <View className="border border-black/10 bg-white p-6">
            ...
            <View className="items-center py-6">
              <ThemedText style={{ color: '#888888', fontSize: 14 }}>Amount Paid</ThemedText>
              <ThemedText
                className="mt-2"
                style={{
                  fontSize: 32,
            ...
            <View className="gap-4 border-b border-t border-gray-100 py-4">
              <View className="flex-row justify-between">
                <ThemedText style={{ color: '#888888' }}>Reference</ThemedText>
                <ThemedText style={{ color: '#000000', fontFamily: Fonts.medium }}>
              ...
              <View className="flex-row justify-between">
                <ThemedText style={{ color: '#888888' }}>Payment Type</ThemedText>
                <ThemedText style={{ color: '#000000', fontFamily: Fonts.medium }}>
                  {transaction.type.replace(/_/g, ' ')}
                </ThemedText>
              </View>
            ...
            <View className="mt-6 items-center">
              <View className="rounded-lg border bg-white p-2" style={{ borderColor: '#cccccc' }}>
                <ThemedBarcode
                  width={300}
                  height={60}
                  format="CODE128"
              ...
              <ThemedText className="mt-2" style={{ color: '#888888', fontSize: 12 }}>
